...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("2026-07-31T13:46:01", "2026-07-31T13:46:01", "shadow_time_invalid"),
        ("2026-07-31T13:45:50", "2026-07-31T13:46:01", "shadow_time_invalid"),
    ],
)
...
def test_scale500_systemd_candidate_is_sim_only_rollback_capable_and_exactly_scheduled() -> (
    ...
    assert "15:06:00" in paper_timer
