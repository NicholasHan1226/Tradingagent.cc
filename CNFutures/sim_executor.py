...
def cn_futures_sim_execute(
    ...
    return SimResult(
        ...
        raw_response={
            ...
            "bid_price": _safe_float(order.get("bid_price") or order.get("bid1") or order.get("best_bid"), 0.0),
            "ask_price": _safe_float(order.get("ask_price") or order.get("ask1") or order.get("best_ask"), 0.0),
            "bid_size": _safe_int(order.get("bid_size") or order.get("bid_volume") or order.get("bid1_volume"), 0),
            "ask_size": _safe_int(order.get("ask_size") or order.get("ask_volume") or order.get("ask1_volume"), 0),
            "last_trade_date": _normalize_trade_date(order.get("last_trade_date")),
            "expiry_date": _normalize_trade_date(order.get("expiry_date") or order.get("expiration_date") or order.get("delivery_date")),
