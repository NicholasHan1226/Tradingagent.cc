...
import type { ChartEvent, Page, PerformancePoint, SignalRow } from '../types/dashboard'
    ...
    return (
      <div className="theme-layout">
        ...
        <aside className="theme-rail">
          <ContributionPanel />
          <RiskSnapshot setActivePage={setActivePage} />
        </aside>
      </div>
    )
  }
  ...
  if (activePage === '持仓') {
    return (
      <div className="theme-layout">
        ...
        <aside className="theme-rail">
          <AllocationPanel />
          <ResultSummary setActivePage={setActivePage} />
        </aside>
      </div>
    )
  }
