import type { EvidenceHealthModel, MarketPulseHealthModel, MarketTapeRow } from '../../lib/marketTapeViewModel'
import type { Market } from '../../types/dashboard'
import { EvidenceHealth } from './EvidenceHealth'
import { MarketSparkline } from './MarketSparkline'

export function MarketTape({ rows, evidence, pulseHealth, onSelect }: { rows: MarketTapeRow[]; evidence: EvidenceHealthModel; pulseHealth?: MarketPulseHealthModel; onSelect: (market: Market) => void }) {
  return (
    <nav aria-label="市场状态带" className="market-tape">
      ...
      <EvidenceHealth model={evidence} pulseHealth={pulseHealth} />
    </nav>
  )
}
