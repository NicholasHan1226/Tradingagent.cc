...
export const tradingAgentReadModelSources = {
  ...
  performanceTracker: 'legacy frozen forensic only: shared/review/*/style_performance.jsonl',
  styleComparison: 'legacy frozen forensic only: shared/review/*/style_comparison.json',
