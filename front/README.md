...
- 实时收益：模拟盘当前收益、目标差、回撤和收益曲线；A股/CNFutures 默认按 200,000 CNY 展示，US/Crypto/PM 默认按 10,000 USD/USDT/USDC 原币运行并折算成人民币汇总；若账本提供正数 `capital_base`，看板优先展示账本事实，不再强行补到 200,000 CNY。
