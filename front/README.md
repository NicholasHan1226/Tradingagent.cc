...
- 实时收益：模拟盘当前收益、目标差、回撤和收益曲线；A股/CNFutures 默认按 200,000 CNY 展示并可保留人民币档位账本事实，US/Crypto/PM 默认按 10,000 USD/USDT/USDC 原币运行并折算成人民币汇总；美元市场的历史账本 `capital_base` 不覆盖该规范本金，避免旧样本把看板误导回 200,000 CNY。
- 机会管道：从发现机会到进入持仓/继续观察/放弃机会的动态筛选过程。
