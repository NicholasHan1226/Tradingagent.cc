...
> **⚠️ 变更后必须更新本文件。**
>
> 最后更新：2026-07-07 (A股候选池评分样本扩容、CNFutures 当前合约筛选、5分钟供数备源、全量同步降载)
