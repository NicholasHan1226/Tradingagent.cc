...
- [x] 2026-07-09 追加优化 A股动态资金计划：新增 `sample_collection` 样本收集模式；当策略有效样本数低于最小样本数、候选质量达标且风控/数据无异常时，允许 1 笔 20,000-35,000 元探索仓继续积累有效样本，避免 2 个持仓 + 50,000 现金预留长期锁死交易；弱候选、高风险或数据异常仍保持防守/谨慎。
