...
| GitHub 主线 | reviews #8/#10/#11/#12/#13 均已普通合并，`main` 与三条远端市场 lane 的 fresh readback 当前一致；精确 SHA 只保存在当次验收证据 | GitHub main 不等于服务器进程已加载 |
...
- GitHub：review #12 与可移植性修复 review #13 的 `front`、`test` CI 均成功；review #13 普通 merge 后主线为 `b38838a02397cc080160e6cf3dae7c47757d9c85`。
