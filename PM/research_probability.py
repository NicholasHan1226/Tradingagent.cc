...
def _read_marketgraph_research(client: Any, limit: int) -> list[dict[str, Any]]:
...
def generate_pm_model_probabilities(
    *,
    ...
    research_rows = _read_marketgraph_research(marketgraph_client, limit=limit)
    market_by_key = _market_lookup(markets)
